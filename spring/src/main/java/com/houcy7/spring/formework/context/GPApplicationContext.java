package com.houcy7.spring.formework.context;
...
import com.houcy7.spring.formework.beans.GPBeanFactory;
import com.houcy7.spring.formework.beans.config.GPBeanDefinition;
import com.houcy7.spring.formework.beans.config.GPBeanWrapper;
import com.houcy7.spring.formework.beans.support.GPBeanDefinitionReader;
import com.houcy7.spring.formework.beans.support.GPDefaultListableBeanFactory;
...
//        postProcessor.postProcessBeforeInitialization(instance,beanName);
        ...
        GPBeanWrapper beanWrapper = new GPBeanWrapper(instance, instance.getClass());
...
//        //先有鸡还是先有蛋的问题，一个方法是搞不定的，要分两次
        ...
        if(instance.getClass().isInterface()){
            this.factoryBeanInstanceCache.put(instance.getClass().getCanonicalName(), beanWrapper);
